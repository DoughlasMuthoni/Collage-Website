"""
Django settings for proj_mwalatvc project.
...
SECRET_KEY = 'django-insecure-d6hctit+fbfh78dgz4s!t2pwv$x8p=if8ttmc+=bxji65obmj7'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['mwalatvc.onrender.com', 'localhost', '127.0.0.1']
...
ROOT_URLCONF = 'proj_mwalatvc.urls'
...
WSGI_APPLICATION = 'proj_mwalatvc.wsgi.application'
...
#         'NAME': BASE_DIR / 'db.sqlite3',  # Uses the SQLite file in the project directory
#     }
# }
